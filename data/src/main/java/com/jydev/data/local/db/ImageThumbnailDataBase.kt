...
@Database(entities = [ImageThumbnailRemoteKeyEntity::class,ImageThumbnailEntity::class,ImageThumbnailLibraryEntity::class],version = 1)
abstract class ImageThumbnailDataBase : RoomDatabase(){
    ...
    abstract fun libraryDao() : ImageThumbnailLibraryDao
}